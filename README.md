# csn-apigatewaychohethongbanking-nhom3ae-react
...
```bash
git clone https://github.com/organization-codeflow/csn-apigatewaychohethongbanking-nhom3ae-react.git
cd csn-apigatewaychohethongbanking-nhom3ae-react
```
...
- Truy cập: https://sonarcloud.io/project/overview?id=csn-apigatewaychohethongbanking-nhom3ae-react
- Xem các metrics:
